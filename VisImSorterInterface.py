...
class Ui_VisImSorter(object):
    def setupUi(self, VisImSorter):
        ...
        self.frame_9 = QtWidgets.QFrame(self.group_sizes)
        ...
        self.frame_7 = QtWidgets.QFrame(self.group_sizes)
